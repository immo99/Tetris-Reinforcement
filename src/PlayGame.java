...
public class PlayGame extends JPanel implements ActionListener
{
    ...
    private final int learningSteps = 10000;
    ...
    private boolean learnBool = false;
        ...
        public void run()
        {
            ...
            for ( int r = 0; r < numRuns; r++ )
            {
                ...
                for ( int s = 0; s < learningSteps; s++ )
                {
                    ...
                    if( learnBool )
                        agent.learn( (((double)( (learningSteps * numRuns) - (s + (learningSteps * r))) ) / (learningSteps * numRuns)) );
                }
